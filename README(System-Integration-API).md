[file name]: README(System-Integration-API).md
[file content begin]
...
- **BSA14 (SNHC):** анализ интеграционных потоков данных (источники/получатели/словарь/сценарии/нагрузка/частота).
- **BSA15 (DLOR):** спецификация REST API (методы, контракты request/response, mapping, errors, актуализация UC).
...
- [`BSA15_REST/Exercise_00_Terminology.pdf`](BSA15_REST/Exercise_00_Terminology.pdf)  
...
- [`BSA15_REST/Exercise_06_Mapping.pdf`](BSA15_REST/Exercise_06_Mapping.pdf)  
