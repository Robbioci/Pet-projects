[file name]: README(Requirements-Management-QA — NFR).md
[file content begin]
...
Репозиторий содержит артефакты нефункциональных требований (NFR), управления требованиями и QA-части (тест-кейсы) на основе учебного кейса (система онлайн-записи **DLOR**).
